...
#Dataset
xx = pd.read_excel('Top_seven_features.xlsx',sheet_name = 'recommended_hiring')
x = xx.iloc[:,0:]
...
parameters = [{'C' :[1,10,100,1000], 'kernel' :['linear']},
              {'C' :[1,10,100,1000], 'kernel' :['rbf'], 'gamma' :[0.15,0.10,0.08,0.05,0.01]}]
...
plt.plot(accuracies)
plt.title('recommended_hiring Accuracies')
plt.show()
