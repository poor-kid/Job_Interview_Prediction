...
#Dataset
xx = pd.read_excel('Top_seven_features.xlsx',sheet_name = 'overall')
x = xx.iloc[:,0:]
...
print(regressor.score(x_ts,y_ts))
...
from sklearn.model_selection import cross_val_score
accuracies1 = cross_val_score(estimator = regressor1, X = x_tr, y = y_tr, cv = 5,scoring='neg_mean_squared_error')
accuracies1.mean()
accuracies1.std()
